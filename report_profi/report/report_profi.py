...
class ReportProfi(models.AbstractModel):
    ...
    def _get_report_values(self, docids, data=None):
        ...
        for project in project_ids:
            ...
            # On récupère tout les types de travaux dans le champ selection bp_list_desc
            ...
            type_works_sorted_by_bp_list_desc = list_desc + type_works
            type_works_sorted_by_bp_list_desc_without_duplicates = list(dict.fromkeys(type_works_sorted_by_bp_list_desc))
            ...
            chantier = {
                ...
                'type_travaux': type_works_sorted_by_bp_list_desc_without_duplicates,
